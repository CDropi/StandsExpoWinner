...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ks(e,t,n){let r=new Float32Array(hs),i=new U(0,1,0);return new Da({name:`SphericalGaussianBlur`,defines:{n:hs,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Ms(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function As(){return new Da({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Ms(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function js(){return new Da({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ms(),fragmentShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},$d=e((e=>{var t=Symbol.for(`react.transitional.element`);function n(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.jsx=n})),ef=e(((e,t)=>{t.exports=$d()}))(),tf=`./Stands/Mapa_Stands.gltf`,nf=.7,rf=0,af=0,of=0,sf=()=>{let e=(0,l.useRef)(null);return(0,l.useEffect)(()=>{let t=e.current,n=new Kn,r=new Co(50,t.clientWidth/t.clientHeight,.1,5e3);n.add(r);let i=new _u({antialias:!0});i.toneMapping=2,i.toneMappingExposure=1.5,i.shadowMap.enabled=!0,i.setPixelRatio(window.devicePixelRatio),i.setSize(t.clientWidth,t.clientHeight),t.appendChild(i.domElement);let a=new qd(Qd),o=i.getPixelRatio();a.material.uniforms.resolution.value.x=1/(window.innerWidth*o),a.material.uniforms.resolution.value.y=1/(window.innerHeight*o);let s=new kd(r,i.domElement);s.minPolarAngle=.4,s.maxPolarAngle=1.35,s.enableDamping=!0,s.dampingFactor=.08;let c=new Zd(n,r),l=new Xd(i);l.addPass(c),l.addPass(a),n.environment=new so().load([`./EnvMap/px.png`,`./EnvMap/nx.png`,`./EnvMap/py.png`,`./EnvMap/ny.png`,`./EnvMap/pz.png`,`./EnvMap/nz.png`]);let u=new Ao(16777215,4);u.shadow.mapSize=new H(2048,2048),u.shadow.bias=-2e-4,u.castShadow=!0,n.add(u),n.add(u.target);let d=new Ao(16777215,2.5);n.add(d),n.add(d.target);let f=new Ao(16777215,1.8);n.add(f),n.add(f.target);let p=new uo(16777215,4473924,1.5);n.add(p);function m(e){let t=[];if(e.traverse(e=>{if(!e.isMesh)return;let n=new sr().setFromObject(e),r=new U;n.getSize(r),t.push({box:n,diag:r.length()})}),t.length===0)return new sr().setFromObject(e);let n=t.map(e=>e.diag).sort((e,t)=>e-t),r=n[Math.floor(n.length/2)]||0,i=new sr,a=0;return t.forEach(({box:e,diag:t})=>{r>0&&t>r*30||(i.union(e),a++)}),a>0?i:new sr().setFromObject(e)}function h(e){let t=m(e),n=new U,i=new U;t.getSize(n),t.getCenter(i);let a=new Mr;t.getBoundingSphere(a);let o=a.radius,c=Math.max(n.x,n.y,n.z),l=r.fov*(Math.PI/180),p=2*Math.atan(Math.tan(l/2)*r.aspect),h=o/Math.sin(Math.min(l,p)/2);h*=nf,i.x+=h*rf,i.y+=h*af,i.z+=h*of;let g=new sr().setFromObject(e),_=new Mr;g.getBoundingSphere(_);let v=new U(-.45,.55,.65).normalize();r.position.copy(i).addScaledVector(v,h),r.near=Math.max(h/200,.05),r.updateProjectionMatrix(),r.lookAt(i),s.target.copy(i),s.minDistance=h*.25,s.maxDistance=h*2,s.update();let y=i.distanceTo(_.center);r.far=(s.maxDistance+y+_.radius)*1.3,r.updateProjectionMatrix(),u.position.set(i.x+n.x*.4,i.y+c*.6,i.z+n.z*.35),u.target.position.copy(i),u.shadow.camera.left=-o*1.2,u.shadow.camera.right=o*1.2,u.shadow.camera.top=o*1.2,u.shadow.camera.bottom=-o*1.2,u.shadow.camera.far=o*6,u.shadow.camera.updateProjectionMatrix(),d.position.set(i.x-n.x*.4,i.y+c*.5,i.z-n.z*.35),d.target.position.copy(i),f.position.set(i.x+n.x*.1,i.y+c*.15,i.z+n.z*.6),f.target.position.copy(i)}new xu().load(tf,e=>{e.scene.traverse(e=>{e.isMesh&&(e.castShadow=!0,e.receiveShadow=!0)}),n.add(e.scene),h(e.scene)},()=>{},e=>{console.error(`Error cargando el modelo GLTF:`,e)});let g=()=>{let e=t.clientWidth,n=t.clientHeight;r.aspect=e/n,r.updateProjectionMatrix(),i.setSize(e,n),i.setPixelRatio(window.devicePixelRatio),l.setSize(e,n);let o=i.getPixelRatio();a.material.uniforms.resolution.value.x=1/(e*o),a.material.uniforms.resolution.value.y=1/(n*o)};window.addEventListener(`resize`,g);let _,v=()=>{s.update(),l.render(),_=requestAnimationFrame(v)};return v(),()=>{cancelAnimationFrame(_),window.removeEventListener(`resize`,g),s.dispose(),i.dispose(),t.removeChild(i.domElement)}},[]),(0,ef.jsx)(`div`,{className:`Scene`,ref:e,style:{width:`100%`,height:`100vh`}})};function cf(){return(0,ef.jsx)(sf,{})}(0,u.createRoot)(document.getElementById(`root`)).render((0,ef.jsx)(l.StrictMode,{children:(0,ef.jsx)(cf,{})}));